...
The last comment in Example 3 did not include the file names because there were more than two relevant files in the hypothetical commit.
Never include content from the examples in your summaries.
`;
